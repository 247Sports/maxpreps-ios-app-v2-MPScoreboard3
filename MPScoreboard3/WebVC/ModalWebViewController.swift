...
//  MPScoreboard3
//
//  Created by David Smith on 8/23/21.
//
...
protocol ModalWebViewControllerDelegate: AnyObject
{
    func modalWebViewControllerCancelButtonTouched()
}

class ModalWebViewController: UIViewController, WKNavigationDelegate, WKUIDelegate, DTBAdCallback, GADBannerViewDelegate, ContestNotificationsSelectorViewDelegate
{
    weak var delegate: ModalWebViewControllerDelegate?
    ...
    var contestId = "" // Added for contest notifications
    ...
    override func viewDidLoad()
    {
        ...
        */
        ...
        browserInitialHeight = Int(kDeviceHeight) - Int(navView.frame.origin.y) - Int(navView.frame.size.height) - SharedData.bottomSafeAreaHeight
        ...
        navContainerView = UIView(frame: CGRect(x: 20, y:Int(navView.frame.origin.y) + Int(navView.frame.size.height) + browserInitialHeight - 48, width: 80, height: 32))

//
//  NewParentProfileViewController.swift
//  MPScoreboard3
//
//  Created by David Smith on 6/22/23.
//

import UIKit
import AVFoundation

class NewParentProfileViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate
{
    ...
    private func showClaimedProfilesViewController()
    {
        ...
        claimedProfilesVC.userProfileType = "Parent"
    ...
    // MARK: - Get Parent User Profile
    
    private func getParentUserProfile()
    {
        ...
        NewFeeds.getParentUserProfile(careerId: self.careerId) { result, error in
            ...
            if (error == nil)
            {
                print("Get Parent User Profile Success")
                ...
                if (self.profileData.count > 0)
                {
                    ...
                    if (myTeams.count > 0)
                    {
                        ...
                        self.myTeamsHeaderView?.titleLabel.text = "Profiles and Teams"
                    }
                    else
                    {
                        self.tableHasMyTeams = false
                        self.myTeamsHeaderView?.titleLabel.text = "Profiles"
                    }
                }
            }
            else
            {
                print("Get Parent User Profile Failed")
            }
    ...
    override func viewDidLoad()
    {
        ...
        myTeamsHeaderView?.titleLabel.text = "Profiles"

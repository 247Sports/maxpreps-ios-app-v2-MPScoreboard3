//
//  NewFanProfileViewController.swift
//  MPScoreboard3
//
//  Created by David Smith on 7/10/23.
//

import UIKit
import AVFoundation

class NewFanProfileViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate
{
    ...
    private func showClaimedProfilesViewController()
    {
        ...
        claimedProfilesVC.userProfileType = "Fan"
    ...
    // MARK: - Get Fan User Profile
    
    private func getFanUserProfile()
    {
        ...
        NewFeeds.getFanUserProfile() { result, error in
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        if (indexPath.section == 0) // Profile section
        {

...
//  MPScoreboard3
//
//  Created by David Smith on 7/5/22.
//

import UIKit

class EditAccountViewController: UIViewController, UITextFieldDelegate, IQActionSheetPickerViewDelegate
{
    ...
    private var updateEmailVC: UpdateEmailViewController!
    private var updatePasswordVC: UpdatePasswordViewController!
    ...
    func actionSheetPickerView(_ pickerView: IQActionSheetPickerView, didSelect date: Date)
    {
        ...
        birthdateContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
    }
    
    func actionSheetPickerViewDidCancel(_ pickerView: IQActionSheetPickerView)
    {
        genderContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
        birthdateContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
        roleContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
    }
    ...
    func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool
    {
        if (textField == birthdateTextField)
        {
            ...
            birthdateContainerView.layer.borderColor = UIColor.mpDarkGrayColor().cgColor
            genderContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
            roleContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
        ...
        else if (textField == genderTextField)
        {
            ...
            genderContainerView.layer.borderColor = UIColor.mpDarkGrayColor().cgColor
            birthdateContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
            roleContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
        ...
        else if (textField == roleTextField)
        {
            ...
            roleContainerView.layer.borderColor = UIColor.mpDarkGrayColor().cgColor
            genderContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
            birthdateContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
    ...
    {
        updateEmailVC = UpdateEmailViewController(nibName: "UpdateEmailViewController", bundle: nil)
    ...
    {
        updatePasswordVC = UpdatePasswordViewController(nibName: "UpdatePasswordViewController", bundle: nil)
    ...
    override func viewDidLoad()
    {
        ...
        birthdateContainerView.layer.cornerRadius = 8
        birthdateContainerView.layer.borderWidth = 1
        birthdateContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
        birthdateContainerView.clipsToBounds = true
        
        genderContainerView.layer.cornerRadius = 8
        genderContainerView.layer.borderWidth = 1
        genderContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
        ...
        roleContainerView.layer.cornerRadius = 8
        roleContainerView.layer.borderWidth = 1
        roleContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
        roleContainerView.clipsToBounds = true
        ...
        */
        containerScrollView.contentSize = CGSize(width: kDeviceWidth, height: 600)

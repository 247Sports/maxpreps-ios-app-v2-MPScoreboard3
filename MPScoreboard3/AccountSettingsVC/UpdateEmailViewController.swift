...
class UpdateEmailViewController: UIViewController, UITextFieldDelegate
{
    ...
    func textFieldDidBeginEditing(_ textField: UITextField)
    {
        ...
        {
            passwordContainerView.layer.borderColor = UIColor.mpDarkGrayColor().cgColor
        }
    }
    ...
    func textFieldDidEndEditing(_ textField: UITextField)
    {
        ...
        passwordContainerView.layer.borderColor = UIColor.mpHeaderBackgroundColor().cgColor
    }

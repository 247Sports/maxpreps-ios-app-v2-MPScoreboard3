...
class AthleteSearchView: UIView, IQActionSheetPickerViewDelegate, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource, SearchSportViewControllerDelegate
{
        ...
        if (sportArray.count == 2)
        {
            ...
            NewFeeds.searchForAthlete(name:searchTextField!.text!, gender:gender, sport:sport, state: state) { (athletes, error) in
                ...
                if (error == nil)
                {
                    ...
                    if (athletes!.count == 0)
                    {
                        MiscHelper.showAlert(in: kAppKeyWindow.rootViewController, withActionNames: ["OK"], title: "Search Result", message: "No matches were found for that sport.", lastItemCancelType: false) { (tag) in
                ...
                {
                    MiscHelper.showAlert(in: kAppKeyWindow.rootViewController, withActionNames: ["OK"], title: "We're Sorry", message: "The search returned a server error", lastItemCancelType: false) { (tag) in
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool
    {
        ...
        {
            MiscHelper.showAlert(in: kAppKeyWindow.rootViewController, withActionNames: ["OK"], title: "Missing Info", message: "You must enter the name of the athlete.", lastItemCancelType: false) { (tag) in
    ...
    @objc func sportSelectorButtonTouched()
    {
        ...
        kAppKeyWindow.rootViewController!.present(searchSportVC, animated: true)
        {

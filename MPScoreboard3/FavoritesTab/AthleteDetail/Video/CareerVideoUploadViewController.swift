//
//  CareerVideoUploadViewController.swift
//  MPScoreboard3
//
...
class CareerVideoUploadViewController: UIViewController, UITextViewDelegate, VideoUploaderDelegate, VideoUploadAlertViewDelegate
{
    ...
    private var careerVideoTaggedAthletesVC: CareerVideoTaggedAthletesViewController!
    ...
    func videoUploadAlertContinueButtonTouched()
    {
        ...
        videoUploader.uploadCareerVideoWithDelegate(title: titleTextView.text, description: descriptionTextView.text, careerIds: careerIds, videoData: videoData, orientation: orientation)
    }
    ...
    {
        careerVideoTaggedAthletesVC = CareerVideoTaggedAthletesViewController(nibName: "CareerVideoTaggedAthletesViewController", bundle: nil)
        careerVideoTaggedAthletesVC.taggedAthletes = taggedAthletes!
        careerVideoTaggedAthletesVC.selectedAthlete = selectedAthlete
        
        self.navigationController?.pushViewController(careerVideoTaggedAthletesVC, animated: true)
    }
    ...
    override func viewDidLoad()
    {
        ...
        // Load the selectedAthlete as the required taggedAthlete
    ...
    override func viewWillAppear(_ animated: Bool)
    {
        ...
        if (careerVideoTaggedAthletesVC != nil)
        {
            self.taggedAthletes = careerVideoTaggedAthletesVC.taggedAthletes
        }
    ...
    override func viewDidAppear(_ animated: Bool)
    {
        ...
        if (careerVideoTaggedAthletesVC != nil)
        {
            careerVideoTaggedAthletesVC = nil
        }
    }

//
//  CareerVideoTaggedAthletesViewController.swift
//  MPScoreboard3
//
...
class CareerVideoTaggedAthletesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    private var careerVideoRosterSearchVC: CareerVideoRosterSearchViewController!
    ...
    {
        careerVideoRosterSearchVC = CareerVideoRosterSearchViewController(nibName: "CareerVideoRosterSearchViewController", bundle: nil)
        careerVideoRosterSearchVC.selectedAthlete = selectedAthlete
        careerVideoRosterSearchVC.taggedAthletes = taggedAthletes
        self.navigationController?.pushViewController(careerVideoRosterSearchVC, animated: true)
    }
    ...
    override func viewWillAppear(_ animated: Bool)
    {
        ...
        if (careerVideoRosterSearchVC != nil)
        {
            // Update the taggedAthletes array
            taggedAthletes = careerVideoRosterSearchVC.taggedAthletes
        }

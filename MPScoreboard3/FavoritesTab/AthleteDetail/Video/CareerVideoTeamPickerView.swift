//
//  CareerVideoTeamPickerView.swift
//  MPScoreboard3
//
//  Created by David Smith on 11/10/22.
//

import UIKit

protocol CareerVideoTeamPickerViewDelegate: AnyObject
{
    func careerVideoTeamPickerViewDidSelectItem(index: Int)
}

class CareerVideoTeamPickerView: UIView, UITableViewDelegate, UITableViewDataSource
{
    weak var delegate: CareerVideoTeamPickerViewDelegate?
    
    private var roundRectView: UIView!
    private var teamsTableView: UITableView!
    private var careerTeamsArray = [] as! Array<Dictionary<String,Any>>
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        if (indexPath.row == (careerTeamsArray.count - 1))
        {
        ...
        let careerTeam = careerTeamsArray[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        { (finished) in
            ...
            self.delegate?.careerVideoTeamPickerViewDidSelectItem(index: indexPath.row)
        } 
    }
    ...
    @objc func handleTap(sender: UITapGestureRecognizer)
    {
        ...
        { (finished) in
            ...
            self.delegate?.careerVideoTeamPickerViewDidSelectItem(index: self.selectedIndex)
        }
    }
    
    // MARK: - Init Methods
    
    required init(frame: CGRect, careerTeams: Array<Dictionary<String,Any>>, index: Int, buttonFrame: CGRect)
    {

//
//  TeamVideoDarkCareerListView.swift
//  MPScoreboard3
//
...
protocol TeamVideoDarkCareerListViewDelegate: AnyObject
{
...
class TeamVideoDarkCareerListView: UIView, UITableViewDelegate, UITableViewDataSource
{
    weak var delegate: TeamVideoDarkCareerListViewDelegate?
        ...
        NewFeeds.untagAthleteFomVideo(videoId: videoIdCopy, careerId: careerId) { error in
            ...
            if (error == nil)
            {
                ...
                { (finished) in
                    ...
                    self.delegate?.teamVideoDarkCareerListViewAthleteUntagged()
                }
            }
            else
            {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        let taggedAthlete = Athlete(firstName: firstName, lastName: lastName, schoolName: schoolName, schoolState: schoolState, schoolCity: schoolCity, schoolId: schoolId, schoolColor: schoolColor, schoolMascotUrl: schoolMascotUrlString, careerId: careerId, photoUrl: athletePhotoUrlString)
        
        self.delegate?.teamVideoDarkCareerListViewAthleteSelected(taggedAthlete: taggedAthlete)
    }
    ...
    @objc private func closeButtonTouched()
    {
        ...
        { (finished) in
            ...
            self.delegate?.closeTeamVideoDarkCareerListView()
        }
    }

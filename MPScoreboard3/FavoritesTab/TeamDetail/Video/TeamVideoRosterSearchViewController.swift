//
//  TeamVideoRosterSearchViewController.swift
//  MPScoreboard3
//
...
class TeamVideoRosterSearchViewController: UIViewController, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource, TeamVideoTeamPickerViewDelegate
{
    ...
    private var teamPickerView: TeamVideoTeamPickerView!
    ...
    {
        let currentTeam = activeTeams[selectedTeamIndex]
    ...
    private func addAthlete(_ athlete: RosterAthlete, selectedIndexPath: IndexPath)
    {
        ...
        let selectedAthlete = Athlete(firstName: athlete.firstName, lastName: athlete.lastName, schoolName: selectedTeam!.schoolName, schoolState: selectedTeam!.schoolState, schoolCity: selectedTeam!.schoolCity, schoolId: selectedTeam!.schoolId, schoolColor: selectedTeam!.teamColor, schoolMascotUrl: selectedTeam!.mascotUrl, careerId: athlete.careerId, photoUrl: athlete.photoUrl)
    ...
    // MARK: - TeamVideoTeamPickerView Delegate
    ...
    @IBAction func teamSelectorButtonTouched(_ sender: UIButton)
    {
        ...
        teamPickerView = TeamVideoTeamPickerView(frame: CGRect(x: 0, y: 00, width: kDeviceWidth, height: kDeviceHeight), activeTeams: activeTeams, index: selectedTeamIndex, buttonFrame: buttonFrame, schoolName: selectedTeam!.schoolName)
    ...
    override func viewDidLoad()
    {
        ...
        let currentTeam = self.activeTeams[0]
        ...
        self.schoolNameLabel.text = selectedTeam!.schoolName

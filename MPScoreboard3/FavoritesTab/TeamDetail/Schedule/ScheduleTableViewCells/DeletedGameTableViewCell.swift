//
//  DeletedGameTableViewCell.swift
//  MPScoreboard3
//
...
class DeletedGameTableViewCell: UITableViewCell
{
    ...
    func loadData(_ data: Dictionary<String,Any>, teamColor: UIColor, myTeamId: String, gameTypeAliases: Array<String>)
    {
        ...
        */
        ...
        if (tbaTeam == false)
        {
            ...
            let schoolNameLabelMaxWidth = kDeviceWidth - schoolNameLabel.frame.origin.x - 40

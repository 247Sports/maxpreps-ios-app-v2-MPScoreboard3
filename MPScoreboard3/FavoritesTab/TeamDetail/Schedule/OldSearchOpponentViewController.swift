//
//  OldSearchOpponentViewController.swift
//  MPScoreboard3
//
//  Created by David Smith on 9/23/21.
//

import UIKit

class OldSearchOpponentViewController: UIViewController, UITextFieldDelegate, UITableViewDataSource, UITableViewDelegate
{

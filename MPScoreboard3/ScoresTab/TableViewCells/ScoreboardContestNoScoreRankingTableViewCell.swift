//
//  ScoreboardContestNoScoreRankingTableViewCell.swift
//  MPScoreboard3
//
//  Created by David Smith on 10/20/23.
//

import UIKit

class ScoreboardContestNoScoreRankingTableViewCell: UITableViewCell
{

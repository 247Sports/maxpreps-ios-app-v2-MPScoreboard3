//
//  PostGameNoScoreTableViewCell.swift
//  MPScoreboard3
//
...
class PostGameNoScoreTableViewCell: UITableViewCell
{
    ...
    override func awakeFromNib()
    {
        ...
        self.reportScoreButton.layer.cornerRadius = kCornerRadius
        self.reportScoreButton.layer.maskedCorners = [.layerMinXMaxYCorner, .layerMaxXMaxYCorner]
        self.reportScoreButton.clipsToBounds = true

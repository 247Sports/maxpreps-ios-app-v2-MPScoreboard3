//
//  TeamUploadToolTipViewController.swift
//  MPScoreboard3
//
...
protocol TeamUploadToolTipDelegate: AnyObject
{
    func teamUploadToolTipClosed()
}

class TeamUploadToolTipViewController: UIViewController
{
    weak var delegate: TeamUploadToolTipDelegate?
    ...
    @IBAction func closeButtonTouched()
    {
        ...
        { (finished) in
            ...
            self.delegate?.teamUploadToolTipClosed()
    ...
    override func viewDidLoad()
    {
        ...
        let messageText = "Go to your team's Videos tab to post videos, highlights, and game clips."

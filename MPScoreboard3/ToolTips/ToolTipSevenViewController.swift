//
//  ToolTipSevenViewController.swift
//  MPScoreboard3
//
...
protocol ToolTipSevenDelegate: AnyObject
{
    func toolTipSevenClosed()
}

class ToolTipSevenViewController: UIViewController
{
    weak var delegate: ToolTipSevenDelegate?
    ...
    @IBAction func closeButtonTouched()
    {
        ...
        { (finished) in
            ...
            self.delegate?.toolTipSevenClosed()
    ...
    override func viewDidLoad()
    {
        ...
        containerView.frame = CGRect(x: 4, y: kStatusBarHeight + SharedData.topNotchHeight + 44, width: 363, height: 182)

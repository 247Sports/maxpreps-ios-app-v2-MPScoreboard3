//
//  ToolTipEightViewController.swift
//  MPScoreboard3
//
...
protocol ToolTipEightDelegate: AnyObject
{
    func toolTipEightClosed()
}

class ToolTipEightViewController: UIViewController
{
    weak var delegate: ToolTipEightDelegate?
    ...
    @IBAction func closeButtonTouched()
    {
        ...
        { (finished) in
            ...
            self.delegate?.toolTipEightClosed()
    ...
    override func viewDidLoad()
    {
        ...
        containerView.frame = CGRect(x: 4, y: kStatusBarHeight + SharedData.topNotchHeight + 44, width: 363, height: 202)

//
//  MetroFilterSelectorViewController.swift
//  MPScoreboard3
//
//  Created by David Smith on 1/27/22.
//
// This is a modified version of the scoreboard metro selector. Hides Metro and Association

import UIKit

class MetroFilterSelectorViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    @IBOutlet weak var eightManButton: UIButton!
    @IBOutlet weak var eightManLabel: UILabel!
    ...
    private func getScoreboardEntities()
    {
        ...
        NewFeeds.getScoreboardEntities(stateCode: stateCode.lowercased(), genderCommaSport: genderCommaSport, year: selectedYear, season: selectedSeason) { result, error in

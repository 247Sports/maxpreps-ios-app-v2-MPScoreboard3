//
//  NewsVideoShortsHeaderViewCell.swift
//  MPScoreboard3
//
//  Created by David Smith on 11/22/23.
//
...
protocol NewsVideoShortsHeaderViewCellDelegate: AnyObject
{
    func newsVideoShortsHeaderViewCellDidSelectVideo(index: Int)
}

class NewsVideoShortsHeaderViewCell: UITableViewCell, UVPNPlayerViewControllerDelegate, UVPNIMAResourceProviderViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource
{
    weak var delegate: NewsVideoShortsHeaderViewCellDelegate?
    ...
    @IBOutlet weak var newsShortsCollectionView : UICollectionView!
    ...
    {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "NewsShortsCollectionViewCell", for: indexPath) as! NewsShortsCollectionViewCell
    ...
    {
        self.delegate?.newsVideoShortsHeaderViewCellDidSelectVideo(index: indexPath.row)
    }
    ...
    override func awakeFromNib()
    {
        ...
        // Register the NewsShortsCollectionView Cell
        newsShortsCollectionView.register(UINib.init(nibName: "NewsShortsCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "NewsShortsCollectionViewCell")
